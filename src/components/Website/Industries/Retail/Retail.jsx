...
export default function Retail(): React.Component {

    return(
        <>
            <HeroArea text="Retail"/>
            <Breadcrumb currentSection={"Retail"}/>
                    ...
                    <div className="row m-0 align-items-center">
                        <div className="col-xl-7 p-0">
                            <div className="benifit-left text-center text-md-left">
                                <div className="cate">ChatterPy for Retail Stores</div>
                                <h2 className="title">Why Store Owners should use ChatterPy</h2>
