...
export default function RealEstate(): React.Component {
    return(
        <>
            <HeroArea text="Real Estate"/>
            <Breadcrumb currentSection={"Real Estate"}/>
                    ...
                    <div className="row m-0 align-items-center">
                        <div className="col-xl-7 p-0">
                            <div className="benifit-left text-center text-md-left">
                                <div className="cate">ChatterPy for Real Estate Agents</div>
                                <h2 className="title">Why Real Estate Agents should use ChatterPy</h2>
